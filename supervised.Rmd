...
splitIndex <- caret::createDataPartition(events[,outcomeName], p = .28, list = FALSE, times = 7)
...
Se varió el valor de p a 0.28 con 7 particiones (se utilizan para dividir un conjunto de datos en conjuntos de entrenamiento y prueba), además también se cambió el método de entrenamiento a validación cruzada (cv) y se definió un número de pliegues de 10, y estas variaciones mejoraron el accuracy de 0.9837312 a 0.9930140, así mismo se obtuvo una mejora en el valor Kappa de 0.9277821 a 0.9672185
