...
base_path <- "C:/Users/cafa_/Documents/Ciberseguridad/5 DataDriven/PRACTICAS/AE3/AE3/"
...
splitIndex <- createDataPartition(events[,outcomeName], p = .29, list = FALSE, times = 1)
...
objControl <- trainControl(method = 'cv',  # Cambiamos a validación cruzada
...
#Para obtener una mejor precisión de los datos se realizó algunas validaciones, y variaciones de datos y métodos.
#Se varió el valor de p a 0,29, adicional también se cambió el método de entrenamiento a validación cruzada (cv) y se definió un número de pliegues de 10, y estas variaciones mejoraron el accuracy de 0.9837312 a 0.9901395, así mismo se obtuvo una mejora en el valor Kappa de 0.9277821 a 0.9551237
